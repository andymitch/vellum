...
// rather than queued, and instantiating ~10 MB of wasm takes longer than it
// takes a page to send its first command.
//
// Everything else — the command surface, the one-writer-per-vault rule, the
// sentence the second tab gets — is in Rust. See crates/vellum-wasm/src/bridge.rs.
import init, { serve } from "./pkg/vellum_wasm.js";
